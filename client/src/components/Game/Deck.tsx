    ...
    <div className="relative">
      ...
      >
        <CardContent className="p-6 text-center">
          <div className="text-white text-lg font-bold mb-2">Deck</div>
          <div className="text-3xl font-bold text-yellow-400">{stats.total}</div>
          <div className="text-sm text-gray-300">cards left</div>
        </CardContent>
      </Card>

      {showStats && (
        <div className={cn(
          "absolute bottom-full right-0 mb-2 bg-black/90 text-white p-4 rounded-lg shadow-xl z-50",
          "min-w-[200px] transition-opacity duration-200"
        )}>
          <h3 className="font-bold mb-2">Deck Contents</h3>
          
          <div className="mb-3">
            <h4 className="text-sm font-semibold mb-1">By Color:</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold mb-1">By Number:</h4>
